    ...
    try {
      ...
      if (storedFilters) {
        ...
        const validatedFilters: QuestionFilters = {
          ...
          search: (parsed.search === undefined || typeof parsed.search === 'string') ? parsed.search : DEFAULT_FILTERS.search,
          sortBy: (parsed.sortBy === undefined || ['newest', 'difficulty', 'most-attempted', 'number'].includes(parsed.sortBy)) 
            ? parsed.sortBy 
            : DEFAULT_FILTERS.sortBy,
          page: (parsed.page === undefined || (typeof parsed.page === 'number' && parsed.page > 0)) ? parsed.page : DEFAULT_FILTERS.page,
          pageSize: (parsed.pageSize === undefined || (typeof parsed.pageSize === 'number' && parsed.pageSize > 0))
            ? parsed.pageSize 
